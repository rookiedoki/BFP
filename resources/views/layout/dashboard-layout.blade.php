  ...
  <body class="vertical">
    ...
    <div class="wrapper">
      <nav class="topnav navbar ">
        ...
        {{-- <p style="color: white"><h6 style="padding-top: 6px;"><span id='date-time'></span>.</h6></p>
           ...
           <img src="{{auth()->user()->admin->official_image ? asset ('storage/' .auth()->user()->admin->official_image ) : asset('/storage/no/-image.png')}}" alt=""   class="imagePrevieww">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              <form class="inline" action="/logout" method="POST">
                @csrf
              <a href="/manageAdmin" class="dropdown-item fw-bold">{{auth()->user()->admin->name}}</a>
      ...
      <aside class="sidebar-left" hitid="leftSidebar" data-simplebar>
        <a href="#" class="btn collapseSidebar toggle-btn d-lg-none text-muted ml-2 mt-3" data-toggle="toggle">
          <i class="fe fe-x"><span class="sr-only"></span></i>
            ...
            {{-- @foreach($setting as $settings) --}}
            <img src="{{$settings->system_logo ? asset ('storage/' .$settings->system_logo) : asset('/storage/no/-image.png')}}" width="100%" style="padding-top:auto; opacity:0.5; position: absolute;">
        <nav class="vertnav navbar navbar-light">
          <!-- nav bar -->
          <div class="w-100 mb-4 d-flex">
            @foreach($setting as $settings)
             <a class="mx-auto pb-2 text-center" href="/dashboard">
              <img src="{{$settings->barangay_logo ? asset ('storage/' .$settings->barangay_logo) : asset('/storage/no/-image.png')}}" style="width: 50%; padding-top:10%;">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <li class="nav-item dropdown">
              <a href="#ui-elements" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">Station Commanders</span>
              </a>
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/official"><span class="ml-1 item-text">Add Station Commander</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/listBrgyOfficial"><span class="ml-1 item-text">Station Commander List</span></a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              <a href="#forms" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">Business Establishement</span>
              </a>
              <ul class="collapse list-unstyled pl-4 w-100" id="forms">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/residents"><span class="ml-1 item-text">Manage</span></a>
                </li>
                <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              <a href="#profile" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                ...
                <span class="ml-3 item-text">Business Establishment <br/> Profile</span>
              </a>
              <ul class="collapse list-unstyled pl-4 w-100" id="profile">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/listVaccinated"><span class="ml-1 item-text">Assembly</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/listSenior"><span class="ml-1 item-text">Business</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/listPWD"><span class="ml-1 item-text">Educational</span></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link pl-3" href="/listPregnant"><span class="ml-1 item-text">Industrial</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-3" href="/listPregnant"><span class="ml-1 item-text">Mercantile</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-3" href="/listPregnant"><span class="ml-1 item-text">Residential</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-3" href="/listPregnant"><span class="ml-1 item-text">Special Structure</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link pl-3" href="/listPregnant"><span class="ml-1 item-text">Storage</span></a>
                </li>
              </ul>
            </li>
 ...
 --}}
            <p class="text-muted nav-heading mt-4 mb-1">
              ...
              {{-- @php
                  ...
                  $count_blotter = App\Models\Blotter::where('status','pending')->count();
              @endphp

                @php
                $count_reg = App\Models\AdminResidents::where('status','0')->count();
                @endphp
 ...
 --}}
              <li class="nav-item">
                <a class="nav-link" href="/blotter">
                  ...
                  <span class="ml-3 item-text">Request FSIC
                    {{-- <span class="badge badge-danger ml-2 mt-1" id="total-request">
                    @if(intval($count_blotter)>0) {{$count_blotter}} @endif
                    </span> --}}
                  </span>
                </a>
              </li>
              ...
              {{-- <li class="nav-item">
                <a class="nav-link" href="/registration">
                  <i class="fa fa-file-o fe-16"></i>
                  <span class="ml-3 item-text">Residence Registration<span class="badge badge-danger ml-2 mt-1" id="total-request">@if(intval($count_reg)>0) {{$count_reg}} @endif</span></span>
                </a>
              </li> --}}
              {{-- @endif
              @endif --}}
