      ...
      <div class="row mt-2">
        <div class="col-md-12">
            <div class="card-tools mb-2">
                <a href="/certificateOfIndigency?search=&status=approved">
                    <button class="btn btn-success btn-border btn-round btn-sm">
                        <i class="fa fa-arrow-left" aria-hidden="true"></i> Go To Approve
                    </button>
                </a>
                <button class="btn btn-info btn-border btn-round btn-sm float-right" onclick="printDiv('printThis')">
          ...
          <div class="card" id="printThis">
            <div class="card-body cardprint" style="padding: 5%; justify;" id="printThis">
              ...
              <div class="row mt-2">
                ...
                <div class="col-md-12">
                  <div class="text-center">
                    <p class="mt-3 fw-bold fs-3 text-center">BARANGAY INDIGENCY</p>
                  </div>
                  @foreach($setting as $settings)
