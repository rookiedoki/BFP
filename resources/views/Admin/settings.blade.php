          ...
          <div class="tab-pane fade " id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <div class="row">
              <div class="col-sm-4">
                ...
                <div class="profile-img">
                    <img src="{{$settings->barangay_logo2 ? asset ('storage/' .$settings->barangay_logo2) : asset('/storage/no/-image.png')}}" alt="" id="prviewww" style="width: 150px; height:150px"/>
                      <div class="file btn btn-lg btn-primary">Barangay Logo
...
<script>
  barangay_logo2.onchange = evt => {
      const [file] = barangay_logo2.files
      if (file) {
