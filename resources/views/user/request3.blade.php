...
<main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
              <h2 class="fw-bold text-uppercase"><center>Request Certificate of Residency</center></h2>
            </div>
          </section>
          <!-- End Breadcrumbs -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"><h6>Document Type</h6>
                                                <input type="text" readonly class="form-control" name="docType" value="Certificate of Residency" required>
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12" id="referenceNumberField" style="visibility: hidden;"><h6>Reference Number<span>*</span></h6>
                                            <div class="form-group">
                                              <input type="text" name="referenceNumber" id="referenceNumber" class="form-control" pattern="[0-9]{13}"  placeholder="1234567890123" required/>
                                            </div>
                                        </div>
