...
<main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
              <h2 class="fw-bold text-uppercase"><center>Request Certificate of Indigency</center></h2>
            </div>
          </section>
          <!-- End Breadcrumbs -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"><h6>Document Type</h6>
                                                <input type="text" readonly class="form-control" name="docType" value="Certificate of Indigency" required>
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6"><h6>Select Payment Method<span>*</span></h6>
                                            <div class="form-group">
                                                <input type="text" readonly class="form-control" name="paymentMethod" value="Cash on Pick-up" required>
