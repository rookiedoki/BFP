...
<main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        <h2><center>Pregnant Women</center></h2>
      </div>
    </section>
    <!-- End Breadcrumbs -->
           ...
           <form action="/storePregnant" method="POST" enctype="multipart/form-data">
             ...
             <div class="form-row">
                 ...
                 <div class="form-group col-md-4">
                  <label class="labelImage h4">Last Menstrual Period(LMP)<span style="color: red">*</span></label>
                         <input type="date"  name="LMP" class="form-control" value="{{old('LMP')}}" required autocomplete="LMP">
                         @Error('LMP')
                     ...
                     <div class="form-group col-md-4">
                      <label class="labelImage h4">Estimated Date of Confinement(EDC)<span style="color: red">*</span></label>
                       <input type="date"  name="EDC" class="form-control" value="{{old('EDC')}}" required autocomplete="EDC">
                     ...
                     <div class="form-group col-md-3">
                      <label class="labelImage h4">Weight<span style="color: red">*</span></label>
                      <input type="text"  name="weight" class="form-control" placeholder="Please input in kilograms" value="{{old('weight')}}" required autocomplete="weight">
